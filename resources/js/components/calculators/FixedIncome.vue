...
<template class="flex">
    <Card class="w-[600px]">
        ...
        <CardContent>
            <form class="flex items-center justify-center gap-5 flex-col">
                ...
                <div class="grid items-center w-full gap-4">
                    <div class="flex justify-between">
                        ...
                        <div class="flex flex-col space-y-1.5 w-5/12">
                            <Label for="name">Investimento Mensal</Label>
                            <Input id="name" placeholder="0,00"/>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between">
                        <div class="w-5/12">
                            <label for="price" class="block text-sm font-medium leading-6 text-gray-900">Tempo de Investimento</label>
                        ...
                        <div class="w-5/12">
                            <label for="price" class="block text-sm font-medium leading-6 text-gray-900">Rentabilidade</label>
                            <div class="relative mt-2 rounded-md shadow-sm">
                                <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                                    <span class="text-gray-500 sm:text-sm">$</span>
                                </div>
